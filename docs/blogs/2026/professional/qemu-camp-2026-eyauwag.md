...
!!! note "主要贡献者"
    ...
    - 作者：[@eyauwag](https://github.com/eyauwag)
...
## 专业阶段
测试内容主要是跑通 I2C BUS 的单元测试以及 QEMU QTEST 的集成测试。I2C BUS 的单元测试只需要完成 I2CBUS 的函数，能够实现 I2C BUS 的逻辑即可，对于我来说难度不算太大。但是对于 QTEST 的集成测试，却是难度挺大的。我面对的挑战包括：
- 什么是 QTEST
- g233.c 实现了什么功能
- 模块是怎么集成到系统里面去的
- RUST 与 C 语言代码是怎么合作的
- QOM 是什么？RUST 语言如何基于 QOM 建模，将 I2C 模型和 SPI 模型加入到 QEMU 的框架里面去
