...
我目前是信息与通信工程专业研一学生，本科专业为电子信息。由于当前研究方向的就业面相对较窄，因此希望进一步学习嵌入式相关知识，为之后的求职做准备。本科期间接触过一些嵌入式基础内容，也具备一定的 C 语言和计算机系统基础。

参加 QEMU 训练营是学长推荐的。在此之前，我对 QEMU 几乎没有了解。考虑到参加项目不仅能够学习新的技术，也可以积累项目经验，因此报名参加了本次训练营。
